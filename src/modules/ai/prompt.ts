...
const rules = (context: PromptContext): string =>
  [
    ...
    '  diga que não existe e ofereça cadastrar, perguntando o tipo (e fechamento/vencimento',
    '  se for crédito). Só crie depois que ele confirmar e mandar o que falta.',
